...
const PlanningForm = forwardRef(
  ({ employeeData, onClose, openFormModal }, ref) => {
    ...
    const formFields = [
...

      {
        ...
        label: "Work Schedule",
        size: "small",
        selectItems: ["A", "B", "C", "D", "E"],
      },
      {
        name: "type_",
        label: "Type",
        size: "small",
        selectItems: ["DIRECT", "INDIRECT"],
      },
      {
        name: "schedule_time",
        label: "Schedule Time",
    ...
    return (
      ...
      >
        ...
        >
          <Typography
            variant="h6"
            sx={{ fontWeight: "bold", marginBottom: ".5em" }}
